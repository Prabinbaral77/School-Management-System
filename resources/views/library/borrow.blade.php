             ...
             <div class="x_panel">
                ...
                <div class="x_content">
                   ...
                   @if (count($errors) > 0)
                     ...
                     @endif
                   <form method="post" action="{{ route('book.borrowed') }}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="item form-group">
                       ...
                       <div class="item form-group">
                         <label class="col-form-label col-md-3 col-sm-3 label-align">Borrow Date<span class="required">*</span>
                         </label>
                         <div class="col-md-6 col-sm-6 ">
