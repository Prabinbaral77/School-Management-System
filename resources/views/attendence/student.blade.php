                  ...
                  <div class="x_content">
                    <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ route('student.attendence','1') }}"><p class="text text-info">Add Attendence "Nursary"</p></a>
                        <p>&nbsp;</p>
                    ...
                    <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ route('student.attendence',2) }}"><p class="text text-info">Add Attendence "LKG"</p></a>
                        <p>&nbsp;</p>
                    ...
                    <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ route('student.attendence','3') }}"><p class="text text-info">Add Attendence "UKG"</p></a>
                        <p>&nbsp;</p>
                    ...
                    <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ route('student.attendence','4') }}"><p class="text text-info">Add Attendence "1"</p></a>
                        <p>&nbsp;</p>
                    ...
                    <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ route('student.attendence','5') }}"><p class="text text-info">Add Attendence "2"</p></a>
                        <p>&nbsp;</p>
                    ...
                    <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ route('student.attendence','6') }}"><p class="text text-info">Add Attendence "3"</p></a>
                        <p>&nbsp;</p>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ route('student.attendence','7') }}"><p class="text text-info">Add Attendence "4"</p></a>
                        <p>&nbsp;</p>
                    ...
                    <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ route('student.attendence','8') }}"><p class="text text-info">Add Attendence "5"</p></a>
                        <p>&nbsp;</p>
                    ...
                    <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ route('student.attendence','9') }}"><p class="text text-info">Add Attendence "6"</p></a>
                        <p>&nbsp;</p>
                    ...
                    <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ route('student.attendence','10') }}"><p class="text text-info">Add Attendence "7"</p></a>
                        <p>&nbsp;</p>
                    ...
                    <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ route('student.attendence','11') }}"><p class="text text-info">Add Attendence "8"</p></a>
                        <p>&nbsp;</p>
                    ...
                    <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ route('student.attendence','12') }}"><p class="text text-info">Add Attendence "9"</p></a>
                        <p>&nbsp;</p>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ route('student.attendence','13') }}"><p class="text text-info">Add Attendence "10"</p></a>
                        <p>&nbsp;</p>
                    ...
                    <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ route('student.attendence','14') }}"><p class="text text-info">Add Attendence "11"</p></a>
                        <p>&nbsp;</p>
                    ...
                    <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ route('student.attendence','15') }}"><p class="text text-info">Add Attendence "12"</p></a>
                        <p>&nbsp;</p>
