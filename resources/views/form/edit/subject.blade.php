				...
				<div class="">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Class::{{ $editClass[0] }} <small>Teacher::{{ $editTeacher[0] }}</small></h2>
								...
								<div class="x_content">
                                    ...
                                    @endif
									<form method="post" action="{{ route('subject.update',$id) }}" data-parsley-validate class="form-horizontal form-label-left">
                                        @csrf
                                        
										<div class="item form-group">
											<label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Subject Name</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="class" class="form-control" type="text" name="subject" value="{{ $editSubject[0] }}" required>
											</div>
                                        </div>
                                        ...
                                        <div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
											  <select class="js-example-basic-single" name="grade" style="width: 150px;" required>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
											  <select class="js-example-basic-single" name="teacher" style="width: 180px;" required>
