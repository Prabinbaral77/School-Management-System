...
<html lang="eng">
   ...
   <body>
      ...
      <div class="container">
         ...
         <div class="row mt-4">
            <div class="col-sm-3">
               <img src="{{ asset('asset/front_asset/images/team2.jpg') }}" class="img-fluid teachers-img">
            </div>
            <div class="col-sm-9"></div>
            <h5 class="heading-ff">Prabin Baral</h5>
            <p>
               What I Liked most about this school is it converts theoretical individual education program
               into reality and its a place full of positivity where kids are nutured with love, given freedom
               to express themselves and are encourged to follow their passion.
            </p>
         </div>

         <div class="row mt-4">
          <div class="col-sm-3">
             <img src="{{ asset('asset/front_asset/images/team1.jpg') }}" class="img-fluid teachers-img">
          </div>
          <div class="col-sm-9"></div>
          <h5 class="heading-ff">Nikesh Shrestha</h5>
          <p>
             What I Liked most about this school is it converts theoretical individual education program
             into reality and its a place full of positivity where kids are nutured with love, given freedom
             to express themselves and are encourged to follow their passion.
       ...
       <div class="row mt-4">
        <div class="col-sm-3">
           <img src="{{ asset('asset/front_asset/images/team3.jpg') }}" class="img-fluid teachers-img">
        </div>
        <div class="col-sm-9"></div>
        <h5 class="heading-ff">Sanjok Gurung</h5>
        <p>
           What I Liked most about this school is it converts theoretical individual education program
           into reality and its a place full of positivity where kids are nutured with love, given freedom
           to express themselves and are encourged to follow their passion.
